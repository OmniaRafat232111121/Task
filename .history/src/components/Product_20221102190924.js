...
const Product = () => {
  ...
  return (
    <section className='section p-[30px]'>
      <div className='container mx-auto flex justify-center it'>
      <h1 className='text-bold text-3xl flex  justify-center items-center w-[200px] text-gray-900'>Dont Just Take Our wait for it</h1>
        {/* title & subtitle */}
