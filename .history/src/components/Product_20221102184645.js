...
const Product = () => {
  ...
  return (
    <section className='section p-[30px]'>
     ...
     <span className='font-extralight text-orange-600'>Download</span>
       </div>
       <div>
       <h2
       className='text-6xl lg:text-4xl mb-6 font-bold py-3'
     ...
     <span className='font-extralight text-bl'>Download</span>
       </div>
       <div>
       <h2
       className='text-6xl lg:text-4xl mb-6 font-bold py-3'
     ...
     <span className='font-extralight'>Download</span>
       </div>
       </div>
