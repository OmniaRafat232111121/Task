       ...
       className='container mx-auto min-h-[900px] flex justify-center items-center'>
        <div className='flex flex-col lg:gap-x-[30px] gap-y-8 lg:gap-y-0 lg:flex-row items-center justify-center text-center lg:text-left'>
          ...
          {title}
            ...
            <p className='lead mb-5 lg:mb-10 font-extralight' 
            ...
            {/* btn & comp text */}
            <div
              className='flex items-center max-w-sm lg:max-w-full mx-auto lg:mx-0 gap-x-2 lg:gap-x-6 font-extralight'
              variants={fadeIn('right')}
            >
              <button  className='btn btn-md lg:btn-lg bg-orange-600 rounded-md py-[30px] flex justify-center items-center lg:gap-x-4'>
                {btnText}
              </button>
